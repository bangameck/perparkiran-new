...
?>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-7"><img class="bg-img-cover bg-center" src="<?= base_url(); ?>assets/adm/images/login/2.jpg" alt="looginpage"></div>
                <div class="col-xl-5 p-0">
                            ...
                            <div class="login-main">
                                <form class="theme-form" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="us" type="text" name="us" required="" placeholder="ex: uptperparkiranpku">
                                    </div>
                                    <div class="form-group">
                  ...
                  <div class="social mt-4">
                    <div class="btn-showcase"><a class="btn btn-light" href="https://www.linkedin.com/login" target="_blank"><i class="txt-linkedin" data-feather="linkedin"></i> LinkedIn </a><a class="btn btn-light" href="https://twitter.com/login?lang=en" target="_blank"><i class="txt-twitter" data-feather="twitter"></i>twitter</a><a class="btn btn-light" href="https://www.facebook.com/" target="_blank"><i class="txt-fb" data-feather="facebook"></i>facebook</a></div>
                                    ...
                                    <p class="mt-4 mb-0 text-center">Don't have account?<a class="ms-2" href="<?= base_url(); ?>register-for-new-users">Create Account</a></p>
