                            ...
                            <form class="theme-form" action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="nama" required=""
                                        placeholder="ex : Sutor Risman">
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label pt-0">Username</label>
                                    <input class="form-control" type="text" id="username" name="username" required=""
                                        placeholder="ex : upt.perparkiran">
                                    <div class="media">
                                        <div class="text-end">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" name="email" id="email" required="email"
                                        placeholder="ex : risman@gmail.com">
                                    <div class="media">
                                        <div class="text-end">
                                ...
                                <div class="form-group mb-0">
                                    <div class="checkbox p-0">
                                        ...
                                        <label class="text-muted" for="checkbox1_terms_and_conditions">Agree with<a
                                                class="ms-2" data-bs-toggle="modal" data-bs-target="#privacy">Privacy Policy</a></label>
                                    </div>
                                    <button class="btn btn-primary btn-block w-100" type="submit" name="register"
                                        id="submit_button" disabled>Create Account</button>
                                </div>
                  ...
                  <div class="social mt-4">
                    <div class="btn-showcase"><a class="btn btn-light" href="https://www.linkedin.com/login" target="_blank"><i class="txt-linkedin" data-feather="linkedin"></i> LinkedIn </a><a class="btn btn-light" href="https://twitter.com/login?lang=en" target="_blank"><i class="txt-twitter" data-feather="twitter"></i>twitter</a><a class="btn btn-light" href="https://www.facebook.com/" target="_blank"><i class="txt-fb" data-feather="facebook"></i>facebook</a></div>
                                ...
                                <p class="mt-4 mb-0 text-center">Already have an account?<a class="ms-2"
                                        href="<?= base_url(); ?>login-for-users">Sign in</a></p>
                            </form>
                            <?php 
