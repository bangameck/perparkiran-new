                                    ...
                                    <div class="grid-inner row">
                                        <div class="col">
                                            <div class="entry-title">
                                                <h4><a href="<?= base_url(); ?>p/berita/<?= $rp['slug']; ?>"><?= judul($rp['j_blog'], '50'); ?></a>
                                                </h4>
                                            </div>
                    ...
                    <div class="widget clearfix" style="margin-bottom: -20px;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 bottommargin-sm">
                                <div class="counter counter-small"><span data-from="0" data-to="<?= $ptoday; ?>" data-refresh-interval="80" data-speed="3000" data-comma="true"></span></div>
                                <h5 class="mb-0">Pengunjung</h5>
                            </div>

                            <div class="col-lg-6 bottommargin-sm">
                                <div class="counter counter-small"><span data-from="0" data-to="<?= $total; ?>" data-refresh-interval="50" data-speed="2000" data-comma="true"></span></div>
                                <h5 class="mb-0">Total Pengunjung</h5>
                            </div>

                            <div class="col-lg-6 bottommargin-sm">
                                <div class="counter counter-small"><span data-from="0" data-to="<?= $tpengaduan; ?>" data-refresh-interval="50" data-speed="2000" data-comma="true"></span></div>
                                <h5 class="mb-0">Total Pengaduan</h5>
                            </div>
                            <div class="col-lg-6 bottommargin-sm">
                                <div class="counter counter-small"><span data-from="0" data-to="<?= $tps; ?>" data-refresh-interval="50" data-speed="2000" data-comma="true"></span></div>
                    ...
                    <div class="widget clearfix" style="margin-bottom: -20px;">
                        ...
                        <div class="row">
                            <div class="col-6 col-md-12 col-lg-6 clearfix">
                                <iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fweb.facebook.com%2Fdishubkotapku%2F&width=150&layout=button_count&action=like&size=small&share=true&height=46&appId=598262024852855" width="155" height="46" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                            </div>
                            <div class="col-6 col-md-12 col-lg-6 clearfix">
                                <a href="https://twitter.com/DishubPekanbaru?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-count="false">Follow @DishubPekanbaru</a>
