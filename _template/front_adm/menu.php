...
if ($_SESSION['level'] == '1') {
    $hid = '
            ...
            <li class="sidebar-list" ><a class="sidebar-link sidebar-title" href="#"><i
                data-feather="clipboard"></i><span>Data Administrasi</span></a>
            <ul class="sidebar-submenu">
            <li><a href="' . base_url() . 'korlap">Data Korlap</a></li>
            <li><a class="submenu-title" href="#">Data Lokasi<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                <ul class="nav-sub-childmenu submenu-content">
                    <li><a href="' . base_url() . 'lokasi">Per Korlap</a></li>  
            ...
            <li><a class="submenu-title" href="#">Perjanjian Kerjasama<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                <ul class="nav-sub-childmenu submenu-content">
                    ...
                    <li><a href="' . base_url() . 'pks">PKS</a></li>
                </ul>
            </li>
            </ul>
            </li>';
...
?>
<div class="logo-icon-wrapper"><a href="<?= base_url(); ?>"><img class="img-fluid" src="<?= base_url(); ?>assets/adm/images/logo/logo-icon.png" alt=""></a></div>
<nav class="sidebar-main">
    <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
    <div id="sidebar-menu">
        <ul class="sidebar-links" id="simple-bar">
            <li class="back-btn"><a href="<?= base_url(); ?>dashboard"><img class="img-fluid" src="<?= base_url(); ?>assets/adm/images/logo/logo-icon.png" alt=""></a>
            ...
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url(); ?>dashboard"><i data-feather="home"> </i><span>Dashboard</span></a></li>
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" <?= $hide; ?> href="<?= base_url(); ?>profile/<?= $_SESSION['username']; ?>"><i data-feather="user"> </i><span>My
                        Profile</span></a>
            </li>
            <?= $hid; ?>
            <?= $pl; ?>
            ...
            <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#" <?= $hide; ?>><i data-feather="file-text"></i><span>Blog</span></a>
                <ul class="sidebar-submenu">
            ...
            <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="mail"></i><span>Laporan</span></a>
                <ul class="sidebar-submenu">
            ...
            <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="settings"></i><span>Pengaturan</span></a>
                <ul class="sidebar-submenu">
            ...
            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" <?= $hide; ?> href="<?= base_url(); ?>out" onclick="return logout()"><i data-feather="power"> </i><span>Logout</span></a>
            </li>
            <?= $l; ?>
