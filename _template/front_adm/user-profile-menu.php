...
<li class="profile-nav onhover-dropdown p-0 me-0" <?= $hide; ?>>
    <div class="media profile-media"><img class="img-40 rounded-circle" src="<?= base_url() ?>/_uploads/f_usr/<?= $foto; ?>" alt="" width="40">
        <div class="media-body"><span><?= $_SESSION['nama']; ?></span>
            <p class="mb-0 font-roboto"><?= $r ?> <i class="middle fa fa-angle-down"></i></p>
        </div>
    </div>
    <ul class="profile-dropdown onhover-show-div">
        <li><a href="<?= base_url(); ?>profile/<?= $_SESSION['username']; ?>"><i data-feather="user"></i><span>My Profile </span></a></li>
        ...
        <li><a href="<?= base_url(); ?>out" onclick="return logout()"><i
                    data-feather="power"> </i><span>Log out</span></a></li>
    </ul>
</li>