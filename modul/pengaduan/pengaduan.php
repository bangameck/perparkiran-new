                                    ...
                                    <td valign="top">
                                        <div class="btn-group">
                                            <a href="<?= base_url(); ?>pengaduan/edit/<?= $u['slug']; ?>"
                                                class="btn btn-info-gradien" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                title="Edit Pengaduan" <?= $hide; ?>><i class="fa fa-pencil"></i></a>
                                            <a href="<?= base_url(); ?>pengaduan/teruskan/<?= $u['slug']; ?>"
                                                class="btn btn-warning-gradien <?= $dis; ?>" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                            ...
                                            <form action="<?= base_url(); ?>pengaduan/delete" method="POST" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                ...
                                                <?= $hide; ?>>
                                                <input type="hidden" name="id_giat" value="<?= $u['slug']; ?>">
                                                <button class="btn btn-danger-gradien" onclick="return hapus()"><i
                ...
                if (isset($_POST['simpan'])) {
                    ...
                    if ($jumlah_foto > 0) {
                        ...
                        if(!$mail->send()) {
                            ...
                            $db->query("INSERT INTO pengaduan VALUES ('$id','$nama_p','$email_p','$no_hp_p','$j_peng','$slug','$peng','P','NULL','$adm_peng',NOW(),NULL,NOW(),NOW(),NULL)");
...
<?php case 'teruskan' : 
    ...
    if ($csrf==false) {
        ...
        $id= $_GET['id'];
        $d = $db->query("SELECT * FROM pengaduan a, users b WHERE a.adm_peng=b.id AND a.slug='$id'")->fetch_assoc();
        ?>
            ...
            <table>
                ...
                if (isset($_POST['simpan'])) {
                    ...
                    if(!$mail->send()) {
                        ...
                        $db->query("UPDATE pengaduan SET status='T', regu='$regu', tgl_teruskan=NOW() WHERE id_peng='$id'");
                ...
                if (isset($_POST['simpan'])) {
                    ...
                    if ($jumlah_foto > 0) {
                        ...
                        if(!$mail->send()) {
                            ...
                            $db->query("UPDATE pengaduan SET status='S', updated_at=NOW() WHERE id_peng='$id_peng'");
