                ...
                <div class="card-body">
                    <div class="dt-ext table-responsive">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="<?= base_url(); ?>pengaduan/add" class="btn btn-primary-gradien" type="button">Tambah
                                Data</a>
                        </div>
                        <br>
                        <table class="display" id="export-button">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td valign="top"><?= $u['j_pengaduan']; ?><br>
                                    ...
                                    <td valign="top">
                                        <div class="btn-group">
                                            ...
                                            <form action="<?= base_url(); ?>pengaduan/delete" method="POST" <?= $hide; ?>>
