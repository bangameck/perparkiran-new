...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?= base_url(); ?>../../assets/adm/css/vendors/datatable-extension.css">
        ...
        <div class="page-body-wrapper">
            <div class="container-fluid">
                <div class="col-xl-12">
                    <br><br>
                            <div class="row">
                                <small><b>url : <?=$_SERVER['HTTP_REFERER']; ?></b></small>
                                <div class="col-lg-6">
                                    <br>
                                    <table>
                                        <thead>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="gallery my-gallery row" itemscope="">
                                        <?php 
                                            ...
                                            ?>
                                        <figure class="col-xl-3 col-md-4 col-6" itemprop="associatedMedia" itemscope="" style="page-break-before: always;">
