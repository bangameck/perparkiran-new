                            ...
                            <div class="row">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top"><b>:</b></td>
                                                <td><a href="<?= base_url(); ?>profile/<?= $d['username']; ?>"><?= $d['nama']; ?></a>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row gallery grid my-gallery" id="aniimated-thumbnials">
                                        ...
                                        ?>
                                                <figure class="grid-item col-sm-3" data-aos="flip-left"><a href="<?= base_url(); ?>_uploads/f_giat/<?= $dd['n_d_giat']; ?>" data-size="600x600"><img class="img-thumbnail" src="<?= base_url(); ?>_uploads/f_giat/<?= $dd['n_d_giat']; ?>" alt="<?= $dd['n_d_giat']; ?>"></a>
