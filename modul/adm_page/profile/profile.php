                    ...
                    <div class="col-sm-12">
                        <div class="card hovercard text-center">
                            ...
                            <div class="user-image">
                                ...
                                <div class="icon-wrapper" <?= $hd; ?>><a href="<?= base_url(); ?>setting" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Klik untuk mengedit profil"><i class="icofont icofont-pencil-alt-5"></i></a>
                                </div>
                            </div>
                            <div class="info">
                                <div class="row">
                                        ...
                                        <ul class="pagination justify-content-center" <?= $hid; ?><?= $hden; ?>>
                                            <li class="page-item">
                                                <a class="page-link" <?php if ($halaman > 1) {
                                                                            echo "href='" . base_url() . "profile/" . $d['username'] . "/page/$previous'";
                                                                        } ?>>Previous</a>
                                            </li>
                                            <?php
                                            for ($x = 1; $x <= $total_halaman; $x++) {
                                            ?>
                                                <li class="page-item"><a class="page-link" href="<?= base_url(); ?>profile/<?= $d['username']; ?>/page/<?php echo $x ?>"><?php echo $x; ?></a>
                                                </li>
                                            <?php
                                            }
                                            ?>
                                            <li class="page-item">
                                                <a class="page-link" <?php if ($halaman < $total_halaman) {
                                                                            echo "href='" . base_url() . "profile/" . $d['username'] . "/page/$next'";
                                                                        } ?>>Next</a>
                                            </li>
                                        </ul>
                                    </nav>
