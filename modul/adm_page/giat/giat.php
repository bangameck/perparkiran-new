                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="<?= base_url(); ?>giat/edit/<?= $u['id_giat']; ?>" class="btn btn-warning" <?= $hide; ?>><i class="fa fa-pencil"></i></a>
                                                            <a href="<?= base_url(); ?>giat/detail/<?= $u['id_giat']; ?>" class="btn btn-primary"><i class="fa fa-info-circle"></i></a>
                                ...
                                <div class="row g-2">
                                    <div class="col-lg-6 col-md-12">
                                        <label">No Kegiatan :</label>
                                            <input type="text" class="form-control" name="no_giat" value="<?= '06' . '.' . uid('3') . '/Keg-Par/DP-KP/PRK/' . bln_romawi(date('m')) . '/' . date('Y') ?>" readonly>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <label">Di Input Oleh : <i class="fa fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="right" title="Nama penginput otomatis terisi oleh sistem dan tidak dapat diubah."></i></label>
                                            <input type="text" class="form-control" value="<?= $_SESSION['nama']; ?>" readonly>
                                            <input type="hidden" class="form-control" name="adm_giat" value="<?= $_SESSION['id_usr']; ?>">
                                            <div class="valid-feedback">
                                            </div>
                                            <div class="invalid-feedback">
                                                Kegiatan tidak boleh kosong.
                                ...
                                <div class="row g-2">
                                    <div class="col-lg-3 col-md-6">
                                        <label">Tanggal Kegiatan :</label>
                                            <input type="text" class="datepicker-here form-control digits" data-language="en" name="tgl_giat" value="<?= date('m/d/Y'); ?>" required>
                                            <div class="valid-feedback">
                                            </div>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <label">Jam :</label>
                                            <div class="input-group clockpicker pull-center" data-placement="bottom" data-align="top" data-autoclose="true">
                                                <input class="form-control" name="jam_giat" type="text" value="<?= date('H:i'); ?>" required><span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                            </div>
                                            <div class="valid-feedback">
                                            </div>
                                            <div class="invalid-feedback">
                                    ...
                                    ?>
                                        <div class="col-lg-6 col-md-12">
                                            <label">Regu :</label>
                                                ...
                                                <input type="text" class="form-control" name="nm_regu" value="<?= $rg['nm_regu']; ?>" readonly>
                                                <div class="valid-feedback">
                                                </div>
                                                <div class="invalid-feedback">
                                                    Regu tidak boleh kosong.
                                ...
                                <div class="row g-2">
                                    <div class="col-lg-12 col-md-12">
                                        <label">Keterangan Kegiatan :</label>
                                            <textarea name="editor1" rows="10" cols="20" class="form-control editor" required></textarea>
                                            <div class="valid-feedback">
                                            </div>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row g-2">
                                    <div class="col-lg-12 col-md-12">
                                        <label">Dokumentasi : <small style="color: green;">Pilih beberapa gambar atau
                                                video</small></label>
                                            <input class="form-control" name="foto[]" type="file" accept="image/jpeg, image/png, video/3gpp, video/mp4, video/x-m4v, video/quicktime" multiple required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row gallery grid my-gallery" id="aniimated-thumbnials">
                                                    ...
                                                    ?>
                                                            <figure class="grid-item col-sm-3" data-aos="flip-left"><a href="<?= base_url(); ?>_uploads/f_giat/<?= $dd['n_d_giat']; ?>" data-size="1600x950"><img class="img-thumbnail" src="<?= base_url(); ?>_uploads/f_giat/<?= $dd['n_d_giat']; ?>" alt="<?= $dd['n_d_giat']; ?>"></a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs nav-primary" id="pills-warningtab" role="tablist">
                                        ...
                                        <li class="nav-item"><a class="nav-link" id="pills-warningprofile-tab" data-bs-toggle="pill" href="#pills-warningprofile" role="tab" aria-controls="pills-warningprofile" aria-selected="false"><i class="icofont icofont-picture"></i>Dokumentasi</a></li>
                                    </ul>
                                            ...
                                            <div class="card-body">
                                                <form class="row g-3 needs-validation form theme-form" novalidate="" action="" method="POST" enctype="multipart/form-data">
                                                    <div class="row g-2">
                                                        <div class="col-lg-6 col-md-12">
                                                            <label">No Kegiatan :</label>
                                                                <input type="text" class="form-control" name="no_giat" value="<?= $d['no_giat']; ?>" readonly>
                                                                <div class="valid-feedback">
                                                                </div>
                                                                <div class="invalid-feedback">
                                                                    Kegiatan tidak boleh kosong.
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-lg-3 col-md-6">
                                                            <label">Tanggal Kegiatan :</label>
                                                                <input type="text" class="datepicker-here form-control digits" data-language="en" name="tgl_giat" value="<?= date('m/d/Y', strtotime($d['tgl_giat'])); ?>" required>
                                                                <div class="valid-feedback">
                                                                </div>
                                                                <div class="invalid-feedback">
                                                                    Tanggal tidak boleh kosong.
                                                        ...
                                                        <div class="col-lg-3 col-md-6">
                                                            <label">Jam :</label>
                                                                <div class="input-group clockpicker pull-center" data-placement="bottom" data-align="top" data-autoclose="true">
                                                                    <input class="form-control" name="jam_giat" type="text" value="<?= date('H:i', strtotime($d['tgl_giat'])); ?>" required><span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                                                </div>
                                                                <div class="valid-feedback">
                                                                </div>
                                                                <div class="invalid-feedback">
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-lg-12 col-md-12">
                                                            <label">Keterangan Kegiatan :</label>
                                                                <textarea name="editor1" rows="10" cols="20" class="form-control editor" required><?= $d['ket_giat']; ?></textarea>
                                                                <!-- <script>
