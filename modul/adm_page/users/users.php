                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="btn-group">
                                                            ...
                                                            <a class="btn btn-success btn-sm" href="<?= base_url(); ?>users/edit/<?= $u['id']; ?>"><i class="fa fa-pencil"></i> Edit</a>
                                                    ...
                                                    <button class="btn btn-warning btn-sm" type="submit"><i class="fa fa-pencil"></i> Edit</button>
                                                            ...
                                                            <form action="<?= base_url(); ?>users/blokir" method="POST">
                                                                <input type="hidden" name="id" value="<?= $u['id']; ?>">
                                                                <button class="btn btn-danger btn-sm" onclick="non()" type="submit"><i class="fa fa-exclamation-circle"></i> Blokir</button>
                                                            </form>
                                                        </div>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="btn-group">
                                                            ...
                                                            <form action="<?= base_url(); ?>users/aktif" method="POST">
                                                                ...
                                                                <button class="btn btn-success btn-sm" onclick="aktif()" type="submit"><i class="fa fa-check"></i> Aktif</button>
                                                            </form>
                                                            <!-- <form action="<?= base_url(); ?>users/blokir" method="POST">
                                                <input type="hidden" name="id" value="<?= $u['id']; ?>">
                                                <input type="hidden" name="username" value="<?= $u['username']; ?>">
                                                ...
                                                href="<?= base_url(); ?>users/edit/<?= $u['id']; ?>"><i
                                                    ...
                                                    <button class="btn btn-warning btn-sm" type="submit"><i class="fa fa-pencil"></i> Edit</button>
                                                            ...
                                                            <form action="<?= base_url(); ?>users/delete" method="POST">
                                                                ...
                                                                <input type="hidden" name="username" value="<?= $u['username']; ?>">
                                                                <input type="hidden" name="foto" value="<?= $u['f_usr']; ?>">
                                                                <button class="btn btn-danger btn-sm" onclick="hapus()" type="submit"><i class="fa fa-trash"></i> Delete Permanent</button>
                                                            </form>
                                                        </div>
                                                    </td>
                                                </tr>
                    ...
                    <div class="container-fluid">
                        <div class="edit-profile">
                            <div class="row">
                                      ...
                                      <p><?= $desc; ?></p>
                                            ...
                                            <form class="row g-3 needs-validation form theme-form" novalidate="" action="" method="post" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" name="username" id="username" value="<?= $d['username']; ?>" required>
                                                    <div class="media">
                                                        <div class="text-end">
                                                            <label id="message"></label>
                                                        </div>
                                    ...
                                    <div class="invalid-feedback">
                                        Password Lama tidak boleh kosong.
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="password" class="form-control password" name="password" placeholder="Password Baru" required>
                                                    <div class="media">
                                                        <div class="text-end switch-sm switch-outline">
                                                            <label class="switch">
                                ...
                                <div class="col-xl-8">
                                    <form class="card g-3 needs-validation form theme-form" novalidate="" action="" method="post" enctype="multipart/form-data">
                                        <div class="card-header">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="email" name="email" value="<?= $d['email']; ?>" required>
                                                    </div>
                                                    <div class="invalid-feedback">
                                                        Email tidak boleh kosong.
                                                    </div>
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="no_hp" value="<?= $d['no_hp']; ?>" onkeypress="return hanyaAngka(event)">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Pendidikan Terakhir</label>
                                                        <input class="form-control" type="text" name="pendidikan" value="<?= $d['pendidikan']; ?>" placeholder="Company">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Alamat</label>
                                                        <textarea class="form-control" name="alamat" rows="1"> <?= $d['alamat']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Kota Kelahiran Lahir</label>
                                                        <input class="form-control" type="text" name="t_lahir" value="<?= $d['t_lahir']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                ...
                                                <div class="col-sm-6 col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select js-example-basic-single" name="jk" id="floatingSelect" aria-label="Jenis Kelamin">
                                                            <?php
                                    ...
                                    <div class="card">
                                      ...
                                      <p><?= $desc; ?></p>
                                            ...
                                            <form class="row g-3 needs-validation form theme-form" novalidate="" action="" method="post" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    <label class="form-label">Password Lama</label>
                                                    <input type="password" class="form-control password" name="password_lama" placeholder="Password Lama" required>
                                                    <div class="invalid-feedback">
                                                        Password Lama tidak boleh kosong.
                                                    </div>
                                                </div>
                                    ...
                                    <form class="card g-3 needs-validation form theme-form" novalidate="" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" data-bs-toggle="tooltip" data-bs-placement="right" title="untuk mengubah email silahkan klik menu ubah email">Email <i class="fa fa-info-circle"></i></label>
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Pendidikan Terakhir</label>
                                                        <input class="form-control" type="text" name="pendidikan" value="<?= $d['pendidikan']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="mb-3">
