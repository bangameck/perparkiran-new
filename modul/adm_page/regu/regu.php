                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $karu; ?></td>
                                                    <td>
                                                        <div class="avatar"><img class="b-r-8 img-40" src="_uploads/f_regu/<?= $ft; ?>" alt="#">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="<?= base_url(); ?>regu/edit/<?= $u['id_regu']; ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                                            <a href="<?= base_url(); ?>regu/detail/<?= $u['id_regu']; ?>" class="btn btn-primary"><i class="fa fa-info-circle"></i></a>
                        ...
                        <form class="row g-3 needs-validation form theme-form" novalidate="" action="" method="POST" enctype="multipart/form-data">
                            <div class="row g-2">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <label">Komandan Regu :</label>
                                        <select class="form-select js-example-basic-single" name="karu" id="floatingSelect" aria-label="Pilih Karu">
                            ...
                            <div class="row g-2">
                                <div class="col-lg-3 col-md-6">
                                    <!-- gambar  -->
                                    <div class="avatar"><img class="b-r-8 img-100" src="<?= base_url(); ?>_uploads/f_regu/default.png" id="imgPreview" alt="Image Preview">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <form class="row g-3 needs-validation form theme-form" novalidate="" action="" method="POST" enctype="multipart/form-data">
                                <div class="row g-2">
                                    <div class="col-lg-6 col-md-12">
                                        <label">Nama Regu :</label>
                                            <input type="text" class="form-control" value="<?= $d['nm_regu']; ?>" name="nm_regu" required>
                                            <div class="valid-feedback">
                                            </div>
                                            <div class="invalid-feedback">
                                                Nama Regu tidak boleh kosong.
                                ...
                                <div class="row g-2">
                                    <div class="col-lg-3 col-md-6">
                                        <!-- gambar  -->
                                        <div class="avatar"><img class="b-r-8 img-100" src="<?= base_url(); ?>_uploads/f_regu/<?= $ft; ?>" id="imgPreview" alt="Image Preview">
                                        </div>
                                    </div>
                                    <div class="col-lg-9 col-md-12">
                                        <input class="form-control" id="imgUpload" name="foto" type="file" accept="image/*">
                        ...
                        <div class="user-profile">
                                ...
                                <div class="col-sm-12">
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="col-xl-4 box-col-6" <?= $hden; ?><?= $hidk; ?>>
                                                <div class="card custom-card">
                                                    <div class="card-header"><img class="img-fluid" src="<?= base_url(); ?>_uploads/f_regu/<?= $ftrk; ?>" alt=""></div>
                                                    <div class="card-profile"><img class="rounded-circle" src="<?= base_url(); ?>_uploads/f_usr/<?= $ftk; ?>" alt=""></div>
                                    ...
                                    <li><a href="#"><i class="fa fa-rss"></i></a></li>
                                                    ...
                                                    <div class="text-center profile-details">
                                                        <h4 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Klik untuk melihat profile"><a target="_blank" href="<?= base_url(); ?>profile/<?= $k['username']; ?>"><?= $k['nama']; ?></a>
                                                        </h4>
                                                        <h6><?= $k['email']; ?></h6>
                                                        <h6><?= $desck; ?></h6>
                                                    </div>
                          ...
                          <div class="item"><img src="../assets/images/slider/11.jpg" alt=""></div> -->
                                            <div class="row g-2">
                                                ...
                                                ?>
                                                    <div class="col-xl-4 box-col-6" <?= $hden; ?>>
                                                        <div class="card custom-card">
                                                            <div class="card-header"><img class="img-fluid" src="<?= base_url(); ?>_uploads/f_regu/<?= $ftr; ?>" alt=""></div>
                                                            <div class="card-profile"><img class="rounded-circle" src="<?= base_url(); ?>_uploads/f_usr/<?= $ftu; ?>" alt=""></div>
                                                            <!-- <ul class="card-social">
                                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
                                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                    ...
                                    <li><a href="#"><i class="fa fa-rss"></i></a></li>
                                                            ...
                                                            <div class="text-center profile-details">
                                                                <h4 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Klik untuk melihat profile"><a target="_blank" href="<?= base_url(); ?>profile/<?= $r['username']; ?>"><?= $r['nama']; ?></a>
                                                                </h4>
                                                                <h6><?= $r['email']; ?></h6>
                                                                <h6><?= $descr; ?></h6>
                                                            </div>
                                                    ...
                                                    <ul class="pagination justify-content-center" <?= $hid; ?><?= $hden; ?>>
                                                        <li class="page-item">
                                                            <a class="page-link" <?php if ($halaman > 1) {
                                                                                        echo "href='" . base_url() . "regu/detail/" . $d['regu'] . "/page/$previous'";
                                                                                    } ?>>Previous</a>
                                                        </li>
                                                        <?php
                                                        for ($x = 1; $x <= $total_halaman; $x++) {
                                                        ?>
                                                            <li class="page-item"><a class="page-link" href="<?= base_url(); ?>regu/detail/<?= $d['regu']; ?>/page/<?php echo $x ?>"><?php echo $x; ?></a>
                                                            </li>
                                                        <?php
                                                        }
                                                        ?>
                                                        <li class="page-item">
                                                            <a class="page-link" <?php if ($halaman < $total_halaman) {
                                                                                        echo "href='" . base_url() . "regu/detail/" . $d['regu'] . "/page/$next'";
                                                                                    } ?>>Next</a>
                                                        </li>
                                                    </ul>
                                                </nav>
