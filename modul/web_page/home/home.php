...
<section id="content">
                        ...
                        <div class="fslider" data-speed="800" data-pause="6000" data-arrows="false" data-pagi="false" style="min-height: 0;">
                            <div class="flexslider">
                                <div class="slider-wrap">
                                    ...
                                    ?>
                                        <div class="slide"><a href="<?= base_url(); ?>p/berita/<?= $bn['slug']; ?>"><strong><?= $bn['j_blog']; ?>..</strong></a>
                                        </div>
                                    <?php endwhile; ?>
                                </div>
                            </div>
                ...
                <div class="col-lg-8 bottommargin">
                    ...
                    <div class="row col-mb-50">
                                    ...
                                    <div class="slider-wrap">
                                        ...
                                        ?>
                                            <div class="slide" data-thumb="<?= base_url() ?>_uploads/blog/sampul/<?= $hn['id_blog']; ?>/<?= $hn['sampul']; ?>">
                                                <a href="#">
                                                    <img src="<?= base_url() ?>_uploads/blog/sampul/<?= $hn['id_blog']; ?>/<?= $hn['sampul']; ?>" alt="<?= $hn['sampul']; ?>">
                                                    <div class="bg-overlay">
                                                        <div class="bg-overlay-content text-overlay-mask dark align-items-end justify-content-start">
                                                            <div class="portfolio-desc py-0">
                                                                <h3><a href="<?= base_url(); ?>p/berita/<?= $hn['slug']; ?>"><?= $hn['j_blog']; ?></a>
                                                                </h3>
                                                    ...
                                                    <div class="flip-card-inner">
                                                        <div class="card bg-transparent border-0 text-center">
                                                            <div class="card-body">
                                                                ...
                                                                <p class="card-text fw-normal"><i class="icon-calendar3"></i>&nbsp;
                                            ...
                                            <div class="grid-inner row g-0">
                                                <div class="col-auto">
                                                    <div class="entry-image">
                                                        <a href="<?= base_url(); ?>p/berita/<?= $n_o['slug']; ?>"><img src="<?= base_url() ?>_uploads/blog/sampul/<?= $n_o['id_blog']; ?>/<?= $n_o['sampul']; ?>" alt="<?= $n_o['sampul']; ?>"></a>
                                                    </div>
                                                </div>
                                                <div class="col ps-3">
                                                    ...
                                                    <div class="entry-meta">
                                                        <ul>
                                                            <li><i class="icon-calendar3"></i>
                                                                <?= time_ago(date('Y-m-d H:i:s', strtotime($n_o['tgl']))); ?>
                                                            </li>
                                    ...
                                    ?>
                                        <div class="entry col-md-6">
                                            <div class="grid-inner row g-0">
                                                <div class="col-auto">
                                                    <div class="entry-image">
                                                        <a href="<?= base_url(); ?>p/berita/<?= $n_t['slug']; ?>"><img src="<?= base_url() ?>_uploads/blog/sampul/<?= $n_t['id_blog']; ?>/<?= $n_t['sampul']; ?>" alt="<?= $n_t['sampul']; ?>"></a>
                                                    </div>
                                                </div>
                                                <div class="col ps-3">
                                                    <div class="entry-title">
                                                    ...
                                                    <div class="entry-meta">
                                                        <ul>
                                                            <li><i class="icon-calendar3"></i>
                                                                <?= time_ago(date('Y-m-d H:i:s', strtotime($n_t['tgl']))); ?>
                                                            </li>
                                                            <!-- <li><i class="icon-clock"></i>
                        ...
                        <div class="col-12">
                            ...
                            <div id="oc-testimonials" class="owl-carousel center testimonials-carousel testimonial-full carousel-widget mt-5" data-margin="0" data-items-xs="1" data-items-sm="1" data-items-md="1" data-items-lg="1" data-items-xl="1" data-center="true" data-loop="true" data-autoplay="5000" data-speed="500">
                                <?php
                                    ...
                                    <div class="oc-item">
                                        <div class="testimonial p-4 border-0 shadow-none">
                                            <div class="testi-image">
                                                <a href="#"><img src="<?= base_url(); ?>_uploads/f_usr/default.png" alt="Logo"></a>
                                            </div>
                                            <?= $stars; ?>
    ...
    <div class="container clearfix">
                    ...
                    <div class="flip-card">
                        ...
                        <div class="flip-card-back dark" style="background-image: url('<?= base_url() ?>_uploads/blog/sampul/<?= $o_n['id_blog']; ?>/<?= $o_n['sampul']; ?>')">
                            <div class="flip-card-inner">
                                ...
                                <a href="<?= base_url(); ?>p/berita/<?= $o_n['slug']; ?>" type="button" class="btn btn-outline-light mt-2" style="float:right;">Selengkapnya <i class="icon-line-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- <div class="clear"></div> -->
        <br>
        <center><a href="<?= base_url(); ?>p/berita" class="button button-rounded button-reveal button-large button-border text-end"><i class="icon-arrow-circle-right"></i><span>Tampilkan Seluruh Berita</span></a></center>
    </div>
    <div class="container clearfix">
