<?php 
    ...
    if($v==true){
        if (date('Y-m-d H:i:s', strtotime($v['batas_waktu'])) > date('Y-m-d H:i:s')) {
            ...
            sweetAlert('','verify-error','Waktu Berakhir !','Verifikasi Gagal, Waktu Verifikasi Kadaluawarsa, Batas Verfikasi ' .date('Y-m-d H:i:s', strtotime($v['batas_waktu'])). '. Waktu Saat ini '.date('Y-m-d H:i:s'));
        }
