...
?>
        ...
        <section id="slider" class="slider-element min-vh-75">
            <div class="slider-inner">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-7">
                                <div class="slider-title mb-5 dark clearfix">
                                    <h2 class="text-white text-rotater mb-2" data-separator="," data-rotate="fadeIn" data-speed="1000">UPT Perparkiran <span class="t-rotate text-white d-inline-block">Siap,Tegas,Lugas,Teratur</span>.</h2>
                                ...
                                <form action="<?= base_url(); ?>p/pengaduan/cari" method="GET">
                                    <div class="input-group input-group-lg mt-1">
                                        <input class="form-control rounded border-0" type="search" name="id" placeholder="Inpukan Kode Pengaduan Anda Disini..." aria-label="Search">
                ...
                <div class="video-wrap">
                    <video id="slide-video" poster="<?= base_url(); ?>assets/web/images/poster.jpg" preload="auto" loop autoplay muted>
        ...
        <section id="content">
            <div class="content-wrap" style="overflow: visible;">
                ...
                <!-- Wave Shape Divider
				============================================= -->
                <div class="wave-bottom" style="position: absolute; top: -12px; left: 0; width: 100%; background-image: url('<?= base_url(); ?>assets/web/demos/course/images/wave-3.svg'); height: 12px; z-index: 2; background-repeat: repeat-x; transform: rotate(180deg);">
                </div>

                <!-- Promo Section
				============================================= -->
                <div class="section m-0 d-none d-md-block" style="padding: 120px 0; background: #FFF url('<?= base_url(); ?>assets/web/images/rm.jpg') no-repeat left top / cover">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="<?= base_url(); ?>p/pengaduan#tahapan" class="button button-rounded button-xlarge ls0 ls0 nott fw-normal m-0">Klik Disini</a>
                            </div>
					...
					============================================= -->
                    <div class="wave-bottom" style="position: absolute; top: auto; bottom: 0; left: 0; width: 100%; background-image: url('<?= base_url(); ?>assets/web/demos/course/images/wave-3.svg'); height: 12px; z-index: 2; background-repeat: repeat-x; transform: rotate(180deg);">
                    </div>
                </div>
                ...
                <div class="promo promo-full p-5 footer-stick">
                    ...
                    <div class="row col-mb-50">
                        <div class="col-sm-6 col-lg-3 text-center">
                            ...
                            <div class="counter counter-large" style="color: #1abc9c;"><span data-from="0" data-to="<?= $pengaduan; ?>" data-refresh-interval="50" data-speed="2000"></span></div>
                            <h5>Pengaduan</h5>
                        </div>

                        <div class="col-sm-6 col-lg-3 text-center">
                            <i class="i-plain i-xlarge mx-auto mb-0 icon-folder-check"></i>
                            <div class="counter counter-large" style="color: #e74c3c;"><span data-from="0" data-to="<?= $proses; ?>" data-refresh-interval="50" data-speed="2500"></span></div>
                            <h5>Proses Verifikasi</h5>
                        </div>

                        <div class="col-sm-6 col-lg-3 text-center">
                            <i class="i-plain i-xlarge mx-auto mb-0 icon-hands-helping"></i>
                            <div class="counter counter-large" style="color: #3498db;"><span data-from="0" data-to="<?= $teruskan; ?>" data-refresh-interval="50" data-speed="3500"></span></div>
                            <h5>Ditindaklanjuti</h5>
                        </div>

                        <div class="col-sm-6 col-lg-3 text-center">
                            <i class="i-plain i-xlarge mx-auto mb-0 icon-line-check-circle"></i>
                            <div class="counter counter-large" style="color: #9b59b6;"><span data-from="0" data-to="<?= $selesai; ?>" data-refresh-interval="30" data-speed="2700"></span></div>
                            <h5>Selesai</h5>
                        </div>
                    </div>
                </div>
                ...
                <!-- Featues Section
				============================================= -->
                <div id="tahapan" class="section mt-5 mb-0" style="padding: 120px 0; background-image: url('<?= base_url(); ?>assets/web/images/patern1.jpg'); background-size: auto; background-repeat: repeat">

                    <!-- Wave Shape
					============================================= -->
                    <div class="wave-top" style="position: absolute; top: 0; left: 0; width: 100%; background-image: url('<?= base_url(); ?>assets/web/demos/course/images/wave-3.svg'); height: 12px; z-index: 2; background-repeat: repeat-x;">
                    </div>
                                        ...
                                        <div class="col-xl-12 col-lg-12">
                                            <div class="row col-mb-30 justify-content-center align-items-center">
                                                <div class="col-md-8 feature-box fbox-border fbox-dark fbox-effect">
                                                    ...
                                                    <div class="fbox-content">
                                                        ...
                                                        <p class="text-white"> Input pengaduan anda dengan cara mengisi form
                                                            yang sudah disediakan diwebsite atau melalui Whatsapp ke <a style="color: #00ff00;" href="<?= $no_wa_add; ?>"><?= $no_wa; ?></a>. Isi format
                                                ...
                                                <div class="col-md-4 text-center">
                                                    <img src="<?= base_url(); ?>assets/web/images/1.png" alt="Image Pengaduan" class="p-4">
                                                </div>
                                                ...
                                                <div class="col-md-4 text-center">
                                                    <img src="<?= base_url(); ?>assets/web/images/2.png" alt="Image Verification" class="p-4">
                                                </div>
                                                ...
                                                <div class="col-md-4 text-center">
                                                    <img src="<?= base_url(); ?>assets/web/images/3.png" alt="Image Forward" class="p-4" height="250">
                                                </div>
                                                ...
                                                <div class="col-md-4 text-center">
                                                    <img src="<?= base_url(); ?>assets/web/images/4.png" alt="Image Finish" class="p-4">
                                                </div>
                                                ...
                                                <div class="form">
                                                    ...
                                                    <form class="row mb-0" action="" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-12 form-group">
                                                            <input type="text" name="j_peng" value="" class="sm-form-control border-form-control" placeholder="Judul Pengaduan" disabled />
                                                        </div>
                                                        <div class="col-12 form-group">
                                                            <textarea name="peng" class="sm-form-control border-form-control" disabled>Isi Pengaduan</textarea>
                                                        ...
                                                        <div class="col-12 form-group">
                                                            ...
                                                            <input id="input-6" name="input6[]" type="file" accept="image/jpeg, image/png, video/mp4" multiple class="file-loading" data-show-preview="false" disabled>
                                                        ...
                                                        <div class="col-12 form-group" data-bs-toggle="tooltip" data-bs-placement="top" title="Silahkan Login terlebih dahulu sebelum mengisi form ini.">
                                                            <a href="<?= base_url(); ?>login-for-users" class="button button-rounded w-100 button-large bg-color text-white nott ls0 mx-0" type="submit" name="lapor">Login</a>
                                                            <br>
                                                            <small style="display: block; font-size: 12px; margin-top: 15px; color: #AAA;"><em>Kami
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form">
														...
														<div class="css3-spinner">
                                                            ...
                                                            <div class="col-12 form-group">
                                                                <input type="text" name="j_peng" value="" class="sm-form-control border-form-control required" placeholder="Judul Pengaduan" />
                                                            </div>
                                                            <div class="col-12 form-group">
                                                                <textarea name="peng" class="sm-form-control border-form-control required editor" required>Isi Pengaduan</textarea>
                                                                <!-- <input type="email" id="template-contactform-email" name="template-contactform-email" value="" class="required email sm-form-control border-form-control" placeholder="Your Email Address:" /> -->
                                                            </div>
                                                            ...
                                                            <div class="col-12 form-group">
                                                                <label><small style="color: green;">Pilih gambar atau
                                                                        video bukti pengaduan</small></label>
                                                                <input id="input-6" name="input6[]" type="file" accept="image/jpeg, image/png, video/mp4" class="sm-form-control border-form-control required" multiple class="file-loading" data-show-preview="false">
                                                                <small style="color: red;">Format File : jpg, png, jpeg, jpe,
                                                                    mp4</small><br>
                                                                <small style="color: red;">Jika jumlah file banyak dan berukuran besar
                                                                    maka loading akan
                                                            ...
                                                            <div class="col-12 form-group">
                                                                <button class="button button-rounded w-100 button-large bg-color text-white" type="submit" name="lapor">Lapor!</button>
                                                                <br>
                                                                <small style="display: block; font-size: 12px; margin-top: 15px; color: #AAA;"><em>Kami
                                                                        akan menginformasikan laporan anda secara realtime melalui
                                                                        email.</em></small>
                            ...
                            ?>
                                <div class="col-lg-4 col-sm-12 mb-8">
                                    <div class="feature-box hover-effect shadow-sm fbox-center fbox-bg fbox-light fbox-lg fbox-effect">
                                        <div class="fbox-icon">
                                            <i><img src="<?= base_url(); ?>_uploads/f_regu/<?= $f_regu; ?>" class="border-0 bg-transparent shadow-sm" style="z-index: 2;" alt="Image"></i>
                                        </div>
                                        <div class="fbox-content">
                ...
                <!-- Section Courses
				============================================= -->
                <div class="section topmargin-lg parallax" style="padding: 80px 0 60px; background-image: url('<?= base_url(); ?>assets/web/demos/course/images/icon-pattern.jpg'); background-size: auto; background-repeat: repeat" data-bottom-top="background-position:0px 100px;" data-top-bottom="background-position:0px -500px;">
                    ...
                    <div class="container">
                        ...
                        <div class="row mt-2">
                            ...
                            ?>
                                <div class="col-md-4 mb-5">
                                    ...
                                    alt="<?= $d['n_d_peng']; ?>"></a> -->
                                        <div class="card-body">
                                            <h4 class="card-title fw-bold mb-2"><a href="<?= base_url(); ?>p/pengaduan/<?= $d['slug']; ?>"><?= $d['j_peng']; ?></a>
                                            </h4>
                                            <p class="mb-2 card-title-sub text-uppercase fw-normal ls1"><a href="#" class="text-black-50"><?= r_nama($d['nama_p']); ?></a></p>
                                            ...
                                            <p class="card-text text-black-50 mb-1">
                                                <center>
                                                    <table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td valign="top" data-bs-toggle="tooltip" data-bs-placement="top" title="Hari, Tanggal"><i class="icon-calendar2"></i> </td>
                                                                <!-- <td valign="top"><b>|</b></td> -->
                                                                <td><?= hari(date('D', strtotime($d['tgl_peng']))) . ', ' . tgl_indo(date('Y-m-d', strtotime($d['tgl_peng']))) ?>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td valign="top" data-bs-toggle="tooltip" data-bs-placement="top" title="Pukul"><i class="icon-clock2"></i></td>
                                                                <!-- <td valign="top"><b>|</b></td> -->
                        ...
                        <center><a href="<?= base_url(); ?>p/pengaduan/all" class="button button-rounded button-reveal button-large button-border text-end"><i class="icon-arrow-circle-right"></i><span>Tampilkan Seluruh Pengaduan</span></a></center>
                    </div>
                            ...
                            <div class="portfolio-item">
                                <div class="portfolio-image">
                                    <a href="portfolio-single.html">
                                        <img src="<?= base_url(); ?>_uploads/f_sel/<?= $g['n_d_sel']; ?>" alt="<?= $g['n_d_peng']; ?>">
                                    </a>
                                    <div class="bg-overlay">
                                        <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-speed="350">
                                            <a href="<?= base_url(); ?>_uploads/f_sel/<?= $g['n_d_sel']; ?>" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeInUpSmall" data-hover-speed="350" data-lightbox="image"><i class="icon-line-plus"></i></a>
                                            <a href="<?= base_url(); ?>p/pengaduan/<?= $g['slug']; ?>" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeInUpSmall" data-hover-speed="350"><i class="icon-line-ellipsis"></i></a>
                                        </div>
                            ...
                            <div class="row posts-md col-mb-30">
                                ...
                                ?>
                                    ...
                                    alt="<?= $d['n_d_peng']; ?>"></a> -->
                                            ...
                                            <div class="card-footer py-3 d-flex justify-content-between align-items-center bg-white text-muted" style="background-color: whitesmoke;">
                                                <?= $st; ?>
                                                <!-- <a href="#" class="text-dark position-relative"><i class="icon-line2-user"></i> <span class="author-number">1</span></a> -->
                                            </div>
                                        </div>
                                    ...
                                    <ul class="pagination justify-content-center" <?= $hid; ?><?= $hden; ?>>
                                        <li class="page-item">
                                            <a class="page-link" <?php if ($halaman > 1) {
                                                                        echo "href='" . base_url() . "p/pengaduan/all/page/$previous'";
                                                                    } ?>>Previous</a>
                                        </li>
                                        <?php
                                        for ($x = 1; $x <= $total_halaman; $x++) {
                                        ?>
                                            <li class="page-item"><a class="page-link" href="<?= base_url(); ?>p/pengaduan/all/page/<?php echo $x ?>"><?php echo $x; ?></a>
                                            </li>
                                        <?php
                                        }
                                        ?>
                                        <li class="page-item">
                                            <a class="page-link" <?php if ($halaman < $total_halaman) {
                                                                        echo "href='" . base_url() . "p/pengaduan/all/page/$next'";
                                                                    } ?>>Next</a>
                                        </li>
                                    </ul>
                                </nav>
                                ...
                                <div class="mb-0 card course-card hover-effect border-0">
                                    <div class="card-body">
                                        ...
                                        <div class="masonry-thumbs grid-container grid-6" data-big="5" data-lightbox="gallery" <?= $colhide; ?>>
                                            ...
                                            ?>
                                                <a class="grid-item" href="<?= base_url() ?>_uploads/f_peng/<?= $g['n_d_peng']; ?>" data-lightbox="gallery-item">
                                                    <div class="grid-inner">
                                                        <img src="<?= base_url() ?>_uploads/f_peng/<?= $g['n_d_peng']; ?>" alt="<?= $g['n_d_peng']; ?>">
                                                        <div class="bg-overlay">
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="video-container">
                                                                            <video class="afterglow" id="myvideo" width="640" height="360" poster="<?= base_url(); ?>_uploads/f_giat/default.jpg">
                                                                                <source type="video/mp4" src="<?= base_url(); ?>_uploads/v_peng/<?= $dd['n_d_peng']; ?>" data-quality="sd" />
                                                                            </video>
                                ...
                                <div class="card course-card hover-effect border-0">
                                    <div class="card-body">
                                        ...
                                        <div class="masonry-thumbs grid-container grid-6" data-big="5" data-lightbox="gallery" <?= $colhide; ?>>
                                            ...
                                            ?>
                                                <a class="grid-item" href="<?= base_url() ?>_uploads/f_sel/<?= $gs['n_d_sel']; ?>" data-lightbox="gallery-item">
                                                    <div class="grid-inner">
                                                        <img src="<?= base_url() ?>_uploads/f_sel/<?= $gs['n_d_sel']; ?>" alt="<?= $gs['n_d_sel']; ?>">
                                                        <div class="bg-overlay">
                                                            <div class="bg-overlay-content dark">
                                                                <i class="icon-camera h4 mb-0" data-hover-animate="fadeIn"></i>
                                                            </div>
                                                        ...
                                                        ?>
                                                                <div class="col-lg-6">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="video-container">
                                                                            <video class="afterglow" id="myvideo" width="640" height="360" poster="<?= base_url(); ?>_uploads/f_giat/default.jpg">
                                                                                <source type="video/mp4" src="<?= base_url(); ?>_uploads/v_sel/<?= $dds['n_d_sel']; ?>" data-quality="sd" />
                                                                            </video>
                                                                            <!-- <video id="my-video" class="video-js vjs-theme-forest" controls preload="auto"
                                                                width="250"
                                                                poster="<?= base_url(); ?>_uploads/f_giat/<?= $dd['n_d_giat']; ?>"
