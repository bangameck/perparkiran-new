                    ...
                    <div class="row posts-md col-mb-30">
                        ...
                        <nav>
                                    <ul class="pagination justify-content-center" <?= $hid; ?><?= $hden; ?>>
                                        <li class="page-item">
                                            <a class="page-link"
                                                <?php if($halaman > 1){ echo "href='".base_url()."p/berita/page/$previous'"; } ?>>Previous</a>
                                        </li>
                                        <?php 
                                            for($x=1;$x<=$total_halaman;$x++){
                                        ?>
                                        <li class="page-item"><a class="page-link"
                                                href="<?= base_url(); ?>p/berita/page/<?php echo $x ?>"><?php echo $x; ?></a>
                                        </li>
                                        <?php
                                            }
                                        ?>
                                        <li class="page-item">
                                            <a class="page-link"
                                                <?php if($halaman < $total_halaman) { echo "href='".base_url()."p/berita/page/$next'"; } ?>>Next</a>
                                        </li>
                                    </ul>   
                                </nav>
                    </div>
                ...
                <div class="postcontent col-lg-9">
                    <div class="single-post mb-0">
                        ...
                        <div class="entry clearfix">
                            ...
                            <div class="entry-content mt-0" style="text-align: justify;">
                                ...
                                <div class="masonry-thumbs grid-container grid-6" data-big="5" data-lightbox="gallery">
                                    ...
                                    ?>
                                    <a class="grid-item"
                                        href="<?= base_url() ?>_uploads/blog/gallery/<?= $d['id_blog']; ?>/<?= $g['n_d_blog']; ?>"
                        ...
                        <!-- Post Author Info
								============================================= -->
                        <div class="card">
                            <div class="card-header"><strong>Posted by <a
                                        href="<?= base_url(); ?>p/post-by/<?= $u['username']; ?>"><?= $u['nama']; ?></a></strong>
                            </div>
                            <div class="card-body">
                                <div class="author-image">
                                    <img src="<?= base_url(); ?>_uploads/f_usr/<?= $f_usr; ?>" alt="<?= $u['nama']; ?>"
                        ...
                        <div class="related-posts row posts-md col-mb-30">
                            ...
                            <div class="entry col-12 col-md-6">
                                <div class="grid-inner row align-items-center gutter-20">
                                    <div class="col-4">
                                        <div class="entry-image">
                                            <a href="<?= base_url(); ?>p/berita/<?= $r['slug']; ?>"><img
                                                    src="<?= base_url(); ?>_uploads/blog/sampul/<?= $r['id_blog']; ?>/<?= $r['sampul']; ?>"
                                                    alt="Blog Single"></a>
                                        </div>
                                    </div>
                                    <div class="col-8">
                                        <div class="entry-title title-xs">
                                            <h3><a
                                                    href="<?= base_url(); ?>p/berita/<?= $r['slug']; ?>"><?= $r['j_blog']; ?></a>
                                            </h3>
                                        </div>
                                        <div class="entry-meta">
                                            <ul>
                        ...
                        <div id="comments" class="clearfix">
                            <div class="fb-comments" data-href="<?= base_url(); ?>p/berita/<?= $id; ?>"
                                                        ...
                                                        <div class="entry-meta">
                                                            <ul>
                                                                <li><i class="icon-calendar2"></i>
                                                                    <?= tgl_indo_singkat(date('y-m-d', strtotime($b['created_at']))).' | '.date('H:i', strtotime($b['created_at'])) ?>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
