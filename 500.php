...
<head>
    ...
    <title>Error 500 | Sistem Informasi Perparkiran</title>
    <!-- Google font-->
...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="error-wrapper">
            <div class="container"><img class="img-100" src="<?= base_url(); ?>assets/images/other-images/sad.png"
                    alt="">
                <div class="error-heading">
                    <h2 class="headline font-primary">500</h2>
                </div>
                <div class="col-md-8 offset-md-2">
                    <p class="sub-content"><b>INTERNAL SERVER ERROR</b><br>"coba muat ulang halaman web, hapus cache,
                        hapus cookie, dan mulai ulang browser."<br><b><i>UPT Perparkiran Dinas Perhubungan Kota
                                Pekanbaru</i></b></p>
                </div>
